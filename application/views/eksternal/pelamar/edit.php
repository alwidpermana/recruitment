              ...
              <div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                                      ...
                                      <section class="scroll-section mb-1" id="singleImageUpload">
                                        <form>
                                          <div class="position-relative d-inline-block" id="singleImageUploadExample">
                                            ...
                                            <input class="file-upload d-none" type="file" accept="image/*" name="inputFoto" id="inputFoto" value="<?=$data->foto?>"/>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="Nama Lengkap" value="<?=$data->nama?>" name="inputNama"/>
                                          ...
                                          <div class="form-floating mb-2">
                                            <input type="text" class="date-picker form-control datePickerFloatingLabel" placeholder="mm/dd/yyyy" name="inputTglLahir" value="<?=date("m/d/Y", strtotime($data->tgl_lahir))?>" />
                      ...
                      <div class="row mt-3 cardAttachment">
                        <div class="col-md-12">
